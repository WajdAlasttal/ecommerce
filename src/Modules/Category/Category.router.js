...
router.get('/:categoryId',auth(Object.values(roles)),validation(validators.getCategoryById),asyncHandler(categoryController.getCategoryById));
router.get('/',auth(Object.values(roles)),asyncHandler(categoryController.getCategories));
